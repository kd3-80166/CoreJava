...
public class Tester {
	...
	public static int emenu() {
		...
		System.out.println("9. To save books in file (Object).");
		System.out.println("10. To read books from file (Object).");
		System.out.println("*******************************************************");
	...
	public static void writeFile (List<Book> l) {
		...
		System.out.println("Book File Saved (Using InputObject).");
	}
	...
	public static void writeObjectFile (List<Book> l) {
		try (FileOutputStream fout = new FileOutputStream("books.bin")){
		...
		System.out.println("Book File Saved (Using OutputObject).");
	}
	...
	public static void main(String[] args) {
		...
		while ((choice = emenu())!=0) {
			...
			case 9 : writeObjectFile(l);
					 break;
			
			case 10: readObjectFile ();
					 break;
